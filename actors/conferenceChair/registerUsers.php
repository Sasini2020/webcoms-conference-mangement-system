	...
	<div id="main-wrapper">
		...
		<br><br>
			...
			<fieldset>
			  ...
			  <label for="actorType"><b>Select User Type <span style="color:red;">*</span></b></label><br>
     ...
     <select id="phoneCode" name="phoneCode" style="width:100px;"  >
      ...
      <br>
        ...
        <label for="Email"><b>Email <span style="color:red;">*</span></b></label><br>
			  <input id='email' name="email" type="text" class="inputvalues" placeholder="Type your E-mail"  required/><br>
        <br>
		</fieldset>
