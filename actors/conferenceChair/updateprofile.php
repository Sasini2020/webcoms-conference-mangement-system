...
<body>
	...
	<nav>
      ...
      <input type="checkbox" id="click">
		...
		<ul>
			<li><a class="active" href="conferencechairhomepage.php">Back to Home</a></li>
	...
	<div id="main-wrapper">
      ...
      <br>
		...
		<?php
          ...
          $query2 = "update conferencechair set title='$aTitle', fullname = '$fullname',
          organization = '$Organization', country = '$country', contactdetails = '$ContactDetails'
          WHERE emailconfchair = '$email'";
