 ...
 <br><br>
   ...
   <div id="main-wrapper"> 
     ...
     <?php  
        ...
        ?>
           <form action="rev_change_password.php" method="post" class="myform">
               <fieldset>
     ...
     <?php
         if(isset($_POST["changePass"])){
           $aEmail = $_SESSION['r_email'];
           $currentPass = $_POST['currentPass'];
           $newPass = $_POST['newPwd']; 
           $conNewPass = $_POST['CNPwd'];
           
           $query_result = mysqli_query($con,"select password from reviewer where emailreviewer='$aEmail'");
           ...
           if($row['password'] == $encriptedCurrentPass){
              ...
              if($newPass == $conNewPass){
                ...
                $query1_r = mysqli_query($con,"update userinfotable set password='$encriptedNewPass'
                            where (email = '$aEmail') and (user_type = 'Reviewer')");
                
                $query2_r = mysqli_query($con,"update reviewer set password='$encriptedNewPass' where emailreviewer = '$aEmail'");
