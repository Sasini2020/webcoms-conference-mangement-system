 ...
 <nav>
       <div class="logo">WebComs</div>
        ...
        <ul>
            ...
            <li><a class="active" href="rev_change_password.php">Change Password</a></li>
          ...
          require '../../dbconfig/config.php';
               ...
               if(empty($password)||empty($c_password)){
                ...
                if(!mysqli_stmt_prepare($stmt,$query)){
                  ...
                  mysqli_stmt_bind_param($stmt,"ss",$r_email,$user_type);
                  ...
                  if(!$row=mysqli_fetch_assoc($result) ){
                      ...
                      if(!mysqli_stmt_prepare($stmt,$sql)){
                            ...
                            $encryptedpass = md5($password);
                             mysqli_stmt_bind_param($stmt,"sss", $encryptedpass,$r_email,$user_type);
                             mysqli_stmt_execute($stmt);          
