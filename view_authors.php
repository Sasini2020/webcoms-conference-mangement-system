...
$select = mysqli_query($con, "select * from fileuploadtable where id = '$get'");

$rows = mysqli_fetch_assoc($select);

$conf_id = $rows['id'];
$get_university = $rows['university'];
$rev = $rows['fullname'];
//echo $conf_id;
$query = mysqli_query($con, "select * from fileuploadtable where id ='$conf_id'") or die(mysqli_error($con));
                            ...
                            <div class="p-20">
                                ...
                                <div class="blog-post m-b-30">
                                    ...
                                    <div class="post-title">
                                        <h3>Conference Title: <a href=""></a></h3>
                                    </div>
                                    <div>
                                        <p>
                                ...
                                <div class="m-t-50 blog-post-comment">
                                    <h4 class="text-uppercase">Comments <small></small></h4>
